...
Thank you for looking into contributing to`testrtc-client`! 
...
2. If you're still seeing the error, check to see if somebody else has [already filed the issue](https://github.com/daily-co/testrtc-client/issues) before creating a new one.
...
If you'd like a feature that we don't have yet, we'll ask you to let us know:
